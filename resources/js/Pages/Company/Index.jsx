    ...
    return (
        <>
            <Authenticated auth={props.auth} errors={props.errors}>
                ...
                {showAddButton &&
                        <Link onClick={addForm} className="bg-purple-600 border border-transparent active:bg-purple-600 hover:bg-purple-700 text-white font-bold py-2 px-4 border-purple-900 rounded w-24 mb-5 text-base"> 
                ...
                {showBackButton && 
                    <Link  href={route('companies.index')} className="bg-purple-600 border border-transparent active:bg-purple-600 hover:bg-purple-700 text-white font-bold py-2 px-4 border-purple-900 rounded w-24 mb-5 text-base"> 
