...
export default function Create(props) {
    ...
    const [editForm ,setEditForm] = useState(product?.varitant_prodcts.length > 0?true:false);
  ...
  const varitantproduct = () => {
        ...
        product  &&  product.varitant_prodcts.map((value , index)=>{
            ...
            value.variant_values.map((variant, key)=>{
                 ...
                 console.log(variant.attribute_option.id);
                attributeFiled[variant.attribute_option.id]={
