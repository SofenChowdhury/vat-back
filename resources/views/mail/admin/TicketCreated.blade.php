                            ...
                            <tr>
                                <td class="logo" style="text-align: left;">
                                    <h1><a href="https://fairelectronics.com.bd">
                                            <img src='http://18.139.116.46:3000/assets/images/logo.png' alt="FairVAT" width="150px">
                                        </a></h1>
                                </td>
                            </tr>
                        </table>
                            ...
                            <tr>
                                <td style="padding: 0 2.5em; text-align: left;">
                                    <div class="text">
                                        ...
                                        <h4>Module: {{$ticket->module}}</h4>
                                        <h4>Submitted By: {{$user->name}}</h4>
                                    </div>
                                </td>
                            </tr>
                        </table>
                    ...
                    <td valign="middle" class="hero bg_white" style="padding: 2em 0 2em 0;">
                        <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
                            <tr>
                                <td style="padding: 0 2.5em; text-align: left;">
                                    <div class="text">
                                        <h3>Thank you for reporting the problem!</h3>
                                    </div>
                                </td>
                            </tr>
                        </table>
